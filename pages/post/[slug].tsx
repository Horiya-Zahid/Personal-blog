  ...
  return (
    <div>
        ...
        <article className='w-full mx-auto p-5 bg-secondaryColor/10'>
            ...
            projectId={process.env.NEXT_PUBLIC_SANITY_PROJECT_ID || "dg1n0tvv"}
            content={post.body}
            serializers={{
            h1: (props: any) => (
                <h1
        ...
        <hr className='max-w-lg my-5 mx-auto border[1px] border-secondaryColor' />
        {
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='mt-7 flex flex-col gap-6'>
                <label className='flex flex-col'>
                    ...
                    className='text-base placeholder:text-sm border-b-[1px] border-secondaryColor py-1 px-4 
                    outline-none focus-within:shadow-xl shadow-secondaryColor'
                    type="text"
            ...
            {/* comments */}
            <div className='w-full flex flex-col p-10 my-10 mx-auto shadow-bgColor
            shadow-lg space-y-2'>
